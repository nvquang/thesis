...
def process_listtext(alist_text, alength_allowed, afile_log_notpass):
    ...
    for the_index_text in range(len(alist_text)):
        ...
        if the_alength > alength_allowed:
            ...
            theFileLogNotPass.write( '## ' + str(the_index_text) + ' ##\n')
            theFileLogNotPass.write( '##:' + str(the_atext) + '\n')
            theFileLogNotPass.write( '##:' + str(the_aprocessed) + '\n')
            theFileLogNotPass.write( '##:' + str(the_alength) + '\n')
            theFileLogNotPass.write( '##-----------------------------\n')
